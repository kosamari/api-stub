  ...
  var valueGeneratorsDict = {
    select: function (obj) {
      var types = {
        ...
        random_unique: function () {
          ...
          if (!obj.randomized) {
            obj.randomized = shuffle(obj.choice.slice());
          }
    ...
    datetime: function (obj) {
      ...
      var output = {
        ...
        toGMTString: function (d) {
          return d.toGMTString();
        },
        toLocaleDateString: function (d) {
          return d.toLocaleDateString();
        },
        toLocaleString: function (d) {
          return d.toLocaleString();
        },
        toLocaleTimeString: function (d) {
          return d.toLocaleTimeString();
        },
        toTimeString: function (d) {
          return d.toTimeString();
        },
        toUTCString: function (d) {
...
function createResponseData(instruction, templates) {
  instruction.map(function (inst) {
    if (!templates[inst.key]) {
      return log.templateNotSpecified(inst.key);
    }
    var data = [];
...
function APIData(endpointSettings) {
  ...
  var delaySettings = endpointSettings.delay;
  var errorRate = endpointSettings.errorRate;
